...
// ERROR HANDLING -must be AFTER route connections
...
// Error formatter for ALL errors- incl. error message, errors array, error stack trace (if env is dev) w/ status code
