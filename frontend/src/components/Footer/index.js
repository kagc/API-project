        ...
        <div className="footer-container">
            ...
            <div className="footer-link-section1">
                ...
                <div className="footer-link-section">
                    <span className="footer-links-labels">Documents</span>
                    <div className="footer-cat-holder">

                    <a target="_blank" href="https://github.com/kagc/API-project">Github</a>
                    </div>
                    {/* <div className="footer-cat-holder">
            ...
            <div className="footer-legal-links">
                <div>
                    ...
                    <i class="fa-solid fa-face-laugh-beam"></i> 2022-2023 Agcaoili, K.</div>
                <div id="not-implemented">
                    {/* Placeholder not-Links | To Hold this Space | Hi Hope You're Having a Good Day */}
                    </div>


                <div className="footer-bottom-right"> <a target="_blank" title="Portfolio" href="https://kagc.github.io">
                        <i class="fa-solid fa-folder-closed"></i>
                        </a>
                         <a target="_blank" title="Github" href="https://github.com/kagc">
                        <i class="fa-brands fa-github-alt">
                            ...
                            <a target="_blank" title="AngelList" href="https://angel.co/u/kirin-agcaoili">
                                <i class="fa-brands fa-angellist"></i></a></div>
            </div>
        </div>
        </div>
        </div>
